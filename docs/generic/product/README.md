...
// HCons(head=1000, tail=HCons(head=900, tail=arrow.generic.HNil@245799eb))
```

```kotlin
Account(1000, 900).toHListLabeled()
// HCons(head=Tuple2(a=balance, b=1000), tail=HCons(head=Tuple2(a=available, b=900), tail=arrow.generic.HNil@245799eb))
```
...
// DeferredK(deferred=LazyDeferredCoroutine{New}@138922d0)
```
